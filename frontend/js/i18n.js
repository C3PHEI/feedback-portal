...
var I18n = (function () {
  ...
  var translations = {
    ...
    de: {
      ...
      'inbox.report_already': 'Du hast dieses Feedback bereits gemeldet. Ein Feedback kann nur einmal gemeldet werden.',
      ...
      'history.toast_already_edited': 'Feedback wurde bereits bearbeitet und kann nicht erneut geändert werden.',
      'history.already_edited_info': 'Bereits bearbeitet — keine weitere Änderung möglich',
      'moderation.note_title':      'Von der Moderation geprüft — mit Hinweis behalten',
      ...
      'dept.disclaimer':        'Durchschnittswerte sind ein Orientierungswert und kein abschliessendes Urteil.',
      'dept.drawer_disclaimer': 'Individuelle Feedbacks sind aus Datenschutzgründen nicht einsehbar.',
      'dept.drawer_load_error': 'Fehler beim Laden ({code}). Drawer schliessen und erneut versuchen.',
      ...
      'admin.sync_status_ok':             'Erfolgreich',
      'admin.sync_status_err':            'Fehler',
      'admin.sync_chip_created':          'Neu',
      'admin.sync_chip_updated':          'Aktualisiert',
      'admin.sync_chip_reactivated':      'Reaktiviert',
      'admin.sync_chip_deactivated':      'Deaktiviert',
      'admin.sync_chip_skipped':          'Übersprungen',
      'admin.sync_previous_label':        'Frühere Läufe',
      'admin.retention_period_label':     'Aufbewahrung',
      'admin.retention_years':            '{years} Jahre',
      'admin.retention_active':           'Aktiv',
      'admin.retention_legal_hold_label': 'Legal Hold',
      'admin.retention_none':             'Keine Retention-Daten verfügbar.',

      /* ─── admin.html — System-Status-Karten (Mock) ───── */
      'admin.sys_adsync_title':           'AD Sync',
      'admin.sys_adsync_d1':              'Letzter Sync: Heute, 02:00 UTC',
      'admin.sys_adsync_d2':              'Nächster Sync: Morgen, 02:00 UTC',
      'admin.sys_adsync_d3':              '35 User synchronisiert',
      'admin.sys_email_title':            'E-Mail-Benachrichtigungen',
      'admin.sys_email_d1':               '84 von 86 zugestellt',
      'admin.sys_email_d2':               '2 ausstehend',
      'admin.sys_email_d3':               'Letzte: vor 3 Stunden',
      'admin.sys_retention_title':        'Retention Policy',
      'admin.sys_retention_d1':           'Aufbewahrung: 3 Jahre (aktiv)',
      'admin.sys_retention_d2':           '2 User im 12-Mt. Countdown',
      'admin.sys_retention_d3':           '1 Feedback unter <span class="hl-badge">Legal Hold</span>',
      ...
      'admin.col_feedback_by':           'Feedback von',
      'admin.col_report_date':           'Melde-Datum',
      ...
      'admin.report_already_resolved':  'Bereits bearbeitet',
      ...
      'admin.action_reason_placeholder': 'Warum wird diese Aktion ausgeführt?',
      ...
      'admin.kpi_total_feedbacks':      'Feedbacks gesamt',
      'admin.kpi_anonymous_rate':       'Anonyme Quote',
      'admin.kpi_avg_rating':           'Ø Bewertung',
      'admin.kpi_edited':               'Bearbeitet',
      'admin.kpi_of_all':               'aller Feedbacks',
      'admin.mod_stat_open':            'Offen',
      'admin.mod_stat_resolved':        'Erledigt',
      'admin.mod_stat_dismissed':       'Verworfen',
      'admin.activate_title':           'Benutzer aktivieren',
      'admin.activate_confirm_text':    'Möchtest du diesen Benutzer wirklich wieder aktivieren?',
      'admin.activate_confirm_btn':     '✅ Aktivieren',
    ...
    en: {
      ...
      'inbox.report_already': 'You have already reported this feedback. A feedback can only be reported once.',
      ...
      'history.toast_already_edited': 'Feedback has already been edited and cannot be changed again.',
      'history.already_edited_info': 'Already edited — no further changes allowed',
      'moderation.note_title':      'Reviewed by moderation — retained with a note',
      ...
      'dept.disclaimer':        'Averages are indicative and not a final assessment.',
      'dept.drawer_disclaimer': 'Individual feedback is not visible for privacy reasons.',
      'dept.drawer_load_error': 'Failed to load ({code}). Close the drawer and try again.',
      ...
      'admin.sync_status_ok':             'Successful',
      'admin.sync_status_err':            'Error',
      'admin.sync_chip_created':          'New',
      'admin.sync_chip_updated':          'Updated',
      'admin.sync_chip_reactivated':      'Reactivated',
      'admin.sync_chip_deactivated':      'Deactivated',
      'admin.sync_chip_skipped':          'Skipped',
      'admin.sync_previous_label':        'Previous runs',
      'admin.retention_period_label':     'Retention',
      'admin.retention_years':            '{years} years',
      'admin.retention_active':           'Active',
      'admin.retention_legal_hold_label': 'Legal Hold',
      'admin.retention_none':             'No retention data available.',

      /* ─── admin.html — System status cards (mock) ────── */
      'admin.sys_adsync_title':           'AD Sync',
      'admin.sys_adsync_d1':              'Last sync: Today, 02:00 UTC',
      'admin.sys_adsync_d2':              'Next sync: Tomorrow, 02:00 UTC',
      'admin.sys_adsync_d3':              '35 users synced',
      'admin.sys_email_title':            'Email Notifications',
      'admin.sys_email_d1':               '84 of 86 delivered',
      'admin.sys_email_d2':               '2 pending',
      'admin.sys_email_d3':               'Last: 3 hours ago',
      'admin.sys_retention_title':        'Retention Policy',
      'admin.sys_retention_d1':           'Retention: 3 years (active)',
      'admin.sys_retention_d2':           '2 users in 12-month countdown',
      'admin.sys_retention_d3':           '1 feedback under <span class="hl-badge">Legal Hold</span>',
      ...
      'admin.col_feedback_by':           'Feedback by',
      'admin.col_report_date':           'Report Date',
      ...
      'admin.report_already_resolved':  'Already resolved',
      ...
      'admin.action_retained_desc':     'Borderline, feedback remains visible with a note.',
      'admin.action_redacted':          'Partially Redact',
      'admin.action_redacted_desc':     'Problematic passages will be redacted.',
      'admin.action_removed':           'Remove',
      'admin.action_removed_desc':      'Removed from recipient\'s view, excluded from averages. Irreversible.',
      'admin.action_reason_label':      'Reason (required, at least 10 characters):',
      'admin.action_reason_placeholder': 'Why is this action being taken?',
      'admin.action_hr_intervention':   'HR intervention required',
      'admin.action_hr_escalation':     'Escalate to HR',
      'admin.action_warning_irreversible': 'This action is irreversible.',
      'admin.action_confirm':           'Execute Action',
      'admin.toast_action_executed':    'Action executed',
      'admin.toast_status_set_review':  'Status: Under Review',
      'admin.kpi_total_feedbacks':      'Total Feedbacks',
      'admin.kpi_anonymous_rate':       'Anonymous Rate',
      'admin.kpi_avg_rating':           'Ø Rating',
      'admin.kpi_edited':               'Edited',
      'admin.kpi_of_all':               'of all feedbacks',
      'admin.mod_stat_open':            'Open',
      'admin.mod_stat_resolved':        'Resolved',
      'admin.mod_stat_dismissed':       'Dismissed',
      'admin.activate_title':           'Activate User',
      'admin.activate_confirm_text':    'Do you really want to reactivate this user?',
      'admin.activate_confirm_btn':     '✅ Activate',

      'error.invalid_status':           'Invalid status',
      'error.invalid_action':           'Invalid action',
      'error.reason_required':          'Reason is required',
      'error.reason_too_short':         'Reason too short (at least 10 characters)',
      'error.report_not_found':         'Report not found',
      'error.cannot_modify_resolved':   'Already resolved report cannot be modified',
      'error.user_not_found':           'User not found',
      'error.invalid_role':             'Invalid role',
      'error.department_not_found':     'Department not found',
      'error.cannot_deactivate_self':   'You cannot deactivate yourself',
      'error.cannot_modify_self':       'You cannot modify yourself',
